...
<summary>Linters</summary>
  <ul>
    <li>The project use linters to looking for code error</li>
  </ul>
</details>
...
sh
cd my-folder
git clone https://github.com/Dachrono/MathMagicians.git
...
Feel free to check the [issues page](https://github.com/Dachrono/MathMagicians/issues).
